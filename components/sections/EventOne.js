                    ...
                    <div className="row">
                            ...
                            <div className="inner-box">
                                <div className="content-box">
                                    <div className="image-box">
                                        <figure className="image"><img src="images/resource/event-1.jpg" title="Shital" /></figure>
                        ...
                        <div className="event-block col-lg-6">
                            <div className="inner-box">
                                <div className="content-box">
                                    <div className="image-box">
                                        <figure className="image"><img src="images/resource/event-2.jpg" title="Shital" /></figure>
                                        <span className="date">20 <br /> May</span>
                                    </div>
                                    <h5 className="title"><Link href="#">Starting seo as your home based business</Link></h5>
                                    <ul className="post-info">
                        ...
                        <div className="event-block col-lg-6">
                            <div className="inner-box">
                                <div className="content-box">
                                    <div className="image-box">
                                        <figure className="image"><img src="images/resource/event-3.jpg" title="Shital" /></figure>
                                        <span className="date">20 <br /> May</span>
                                    </div>
                                    <h5 className="title"><Link href="#">Starting seo as your home based business</Link></h5>
                                    <ul className="post-info">
                        ...
                        <div className="event-block col-lg-6">
                            <div className="inner-box">
                                <div className="content-box">
                                    <div className="image-box">
                                        <figure className="image"><img src="images/resource/event-4.jpg" title="Shital" /></figure>
                                        <span className="date">20 <br /> May</span>
                                    </div>
                                    <h5 className="title"><Link href="#">Starting seo as your home based business</Link></h5>
                                    <ul className="post-info">
